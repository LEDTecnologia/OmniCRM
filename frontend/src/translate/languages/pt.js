const messages = {
  pt: {
    translations: {
      ...
      scheduleModal: {
        title: {
          add: "Novo Agendamento de Mensagem",
          edit: "Editar Agendamento de Mensagem",
        },
        form: {
          body: "Mensagem",
          contact: "Contato",
      ...
      campaigns: {
        ...
        table: {
          ...
          status: "Status",
          scheduledAt: "Agendamento de Mensagem",
      ...
      schedules: {
        ...
        confirmationModal: {
          deleteTitle: "Você tem certeza que quer excluir este Agendamento de Mensagem?",
          deleteMessage: "Esta ação não pode ser revertida.",
        },
        table: {
          contact: "Contato",
        ...
        buttons: {
          add: "Agendar nova mensagem",
        },
        toasts: {
          deleted: "Agendamento de Mensagem excluído com sucesso.",
        },
      },
      tags: {
        title: "Tags",
      ...
      ticketOptionsMenu: {
        schedule: "Agendamento de Mensagem",
        delete: "Deletar",
        transfer: "Transferir",
